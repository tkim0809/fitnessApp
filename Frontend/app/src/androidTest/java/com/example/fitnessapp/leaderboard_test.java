...
public class leaderboard_test {
    ...
    public void leaderboard_test() {
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.leaderboardBtn), withText("Leaderboard"),
                        childAtPosition(
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.addpushupsButton), withText("add"),
                        childAtPosition(
                                allOf(withId(R.id.leader_board),
                                        childAtPosition(
                                                withId(android.R.id.content),
                                                0)),
                                2),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.addpushupsEditText),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("78901"), closeSoftKeyboard());

        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.addpushupsBut), withText("add pushups"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.backToLeaderboardBtn), withText("back to leaderboard"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
